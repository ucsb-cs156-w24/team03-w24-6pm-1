...
describe("HelpRequestIndexPage tests", () => {
    ...
    test("renders one request correctly for regular user", async () => {
        
        // arrange
        setupUserOnly();
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/helprequests/all").reply(200, helpRequestFixtures.oneHelpRequest);
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/helprequests/all").reply(200, helpRequestFixtures.threeHelpRequests);
        axiosMock.onDelete("/api/helprequests").reply(200, "HelpRequest with id 2 deleted"); 
        ...
        // assert
        await waitFor(() => { expect(mockToast).toBeCalledWith("HelpRequest with id 2 deleted") }); 
