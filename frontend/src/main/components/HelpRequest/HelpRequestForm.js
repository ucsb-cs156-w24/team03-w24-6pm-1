    ...
    return (
        ...
        <Form onSubmit={handleSubmit(submitAction)}>
            ...
            <Row>
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        <Form.Label htmlFor="tableOrBreakoutRoom">Breakout Room</Form.Label>
                        <Form.Control
                        ...
                        />
                        <Form.Control.Feedback type="invalid">
                            {errors.tableOrBreakoutRoom && 'Breakout Room is required.'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
                <Col>
                    <Form.Group className="mb-3" >
                        <Form.Label htmlFor="requestTime">Time</Form.Label>
                        <Form.Control
                        ...
                        />
                        <Form.Control.Feedback type="invalid">
                            {errors.requestTime && 'Time is required.'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
                <Col>
