...
function UCSBorganisationForm({ initialContents, submitAction, buttonLabel = "Create" }) {
    ...
    const testIdPrefix = "UCSBorganisationForm";
    ...
    return (
        <Form onSubmit={handleSubmit(submitAction)}>
            ...
            <Form.Check // prettier-ignore
                            type="switch"
                            data-testid="UCSBorganisationForm-inactive"
                            id="inactive"
                            label="inactive"
                            {...register("inactive", {})}
                        />
...
export default UCSBorganisationForm;